...
<article class="home_featured">
    ...
    <div class="home_featured_app">
        <img src="<?php echo theme("/assets/images/home-app.jpg") ?>" alt="CafeControl" title="CafeControl"/>
    </div>
</article>
    ...
    <section class="container content">
        ...
        <div class="home_features_content">
            <article class="radius">
                <header>
                    <img alt="Contas a receber" title="Contas a receber" src="<?php echo theme("/assets/images/home_receive.jpg") ?>"/>
            ...
            <article class="radius">
                <header>
                    <img alt="Contas a pagar" title="Contas a pagar" src="<?php echo theme("/assets/images/home_pay.jpg") ?>"/>
            ...
            <article class="radius">
                <header>
                    <img alt="Controle e relatórios" title="Controle e relatórios" src="<?php echo theme("/assets/images/home_control.jpg") ?>"/>
...
<article class="home_optin">
    <div class="home_optin_content container content">
        ...
        <div class="home_optin_content_flex">
            ...
            <form action="<?php echo url("cadastro") ?>" method="post" enctype="multipart/form-data">
